...
def get_trainer_from_args(dataset_name_or_id: Union[int, str],
    ...
    nnunet_trainer = recursive_find_python_class(join(ultrafav.__path__[0], "training", "nnUNetTrainer"),
    ...
    if nnunet_trainer is None:
        raise RuntimeError(f'Could not find requested nnunet trainer {trainer_name} in '
                           f'ultrafav.training.nnUNetTrainer ('
                           f'{join(ultrafav.__path__[0], "training", "nnUNetTrainer")}). If it is located somewhere '
...
def run_training_entry():
    ...
    parser.add_argument('-tr', type=str, required=False, default='NCRTrainerV2',
                        help='[OPTIONAL] Use this flag to specify a custom trainer. Default: NCRTrainerV2')
