...
from ultrafav.training.network_architectures.artery_vein_seg.neighbor_connec_reg_net_v2 import NCRNet
...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        trainer_class = recursive_find_python_class(join(ultrafav.__path__[0], "training", "nnUNetTrainer"),
                                                    trainer_name, 'ultrafav.training.nnUNetTrainer')
        if trainer_class is None:
            raise RuntimeError(f'Unable to locate trainer class {trainer_name} in ultrafav.training.nnUNetTrainer. '
                               f'Please place it there (in any .py file)!')
        ###################### Our UltraFAV model #############################
        self.coarse_model = trainer_class.build_network_architecture(
...
def predict_entry_point():
    ...
    parser.add_argument('-p', type=str, required=False, default='nnUNetPlans',
                        help='Plans identifier. Specify the plans in which the desired configuration is located. '
                             'Default: nnUNetPlans')
    parser.add_argument('-tr', type=str, required=False, default='NCRTrainerV2',
                        help='What nnU-Net trainer class was used for training? Default: NCRTrainerV2')
